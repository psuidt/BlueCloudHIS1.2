...
{
    public partial class FrmTicketTotal : GWI.HIS.Windows.Controls.BaseMainForm
    {
        private User _currentUser;
        private Deptment _currentDept;
        grproLib.GridppReport Report = null;

        public FrmTicketTotal(long currentUserId, long currentDeptId, string chineseName)
        {
            InitializeComponent();
        ...
        private void FrmTicketTotal_Load(object sender, EventArgs e)
        {
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            //ZY_Ticket zyt = new ZY_Ticket();
            //this.dgCost.DataSource = zyt.GetTicketData(this.dtpBdate.Value, this.dtpEdate.Value);
        }
        ...
        {
            GWI_DesReport.HisReport.FillRecordToReport(Report, ((DataTable)this.dgCost.DataSource).DefaultView.ToTable());
        }
        ...
        {
            this.CreateReportFile("住院发票统计", (DataTable)this.dgCost.DataSource);
        }
        //预览
