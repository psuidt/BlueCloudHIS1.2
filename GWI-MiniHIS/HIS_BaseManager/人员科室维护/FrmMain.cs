...
{
    public partial class FrmMain : GWMHIS.BussinessLogicLayer.Forms.BaseForm
    {
        public FrmMain(long UserId,long DeptId,string FormText)
        {
            InitializeComponent( );
            this.Text = FormText;
        ...
        private void ShowAllInfo()
        {
            ...
            Employee[] allEmployees =  Employee.GetEmployeies( "" );
        ...
        private void toolbar_ButtonClick( object sender , ToolBarButtonClickEventArgs e )
        {
            ...
            if ( e.Button.Name == btnAddLayer.Name )
                AddLayer( );

            if ( e.Button.Name == btnEditLayer.Name )
                EditLayer( );

            if ( e.Button.Name == btnDeleteLayer.Name )
                DeleteLayer( );

            if ( e.Button.Name == btnAddDept.Name )
                AddDepartment( );

            if ( e.Button.Name == btnEditDept.Name )
                EditDepartment( );

            if ( e.Button.Name == btnAddEmployee.Name )
                AddEmployee( );

            if ( e.Button.Name == btnEditEmployee.Name )
                EditEmployee( );

            if ( e.Button.Name == btnShowAll.Name )
                ShowAllInfo( );

            if ( e.Button.Name == btnClose.Name )
                this.Close( );
        }
