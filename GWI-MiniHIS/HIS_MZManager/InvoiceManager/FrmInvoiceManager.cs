    ...
    public partial class FrmInvoiceManager : GWI.HIS.Windows.Controls.BaseMainForm
    {
        ...
        private void SetInvoiceStatsu()
        {
            try
            {
                ...
                HIS.MZ_BLL.InvoiceManager.SetInvoiceNoUsed( id );
        ...
        public FrmInvoiceManager( string FormText, GWMHIS.BussinessLogicLayer.Classes.User User )
        {
            InitializeComponent();
        ...
        private void FrmInvoiceManager_Load( object sender , EventArgs e )
        {
            ...
            //cboAllotUser.SetSelectionCardDataSource( HIS.MZ_BLL.PublicDataReader.GetEmployeeList() );
            cboAllotUser.SetSelectionCardDataSource( BaseDataController.BaseDataSet[BaseDataCatalog.人员列表] );
        ...
        {
            dgvInvoiceList.DataSource = HIS.MZ_BLL.InvoiceManager.GetInvoiceRecord().DefaultView;
        ...
        private void btnDelete_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                ...
                if ( HIS.MZ_BLL.InvoiceManager.DeleteInvoiceVolumn( volId ) )
                {
                    ShowGridList( GetStatusFilterString() );
                }
            }
        ...
        private void dgvInvoiceList_CurrentCellChanged( object sender , EventArgs e )
        {
            ...
            try
            {
                HIS.MZ_BLL.InvoiceManager.GetInvoiceListInfo( perfChar , startNo , endNo , out totalMoney , out totalCount , out refundMoney , out refundCount );
