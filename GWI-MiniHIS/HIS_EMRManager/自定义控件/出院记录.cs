...
namespace HIS_EMRManager
{
    ...
    /// 出院记录控件
    /// </summary>
    internal partial class 出院记录 : EMRControl, IEMRPrint
    {
        public 出院记录()
        {
            InitializeComponent();
        ...
        {
            XmlDocument xmlDoc = HIS.EMR_BLL.OP_EmrRecord.GetPatInfo(emrRecord.PatListId, 2, emrRecord.RecordCreateDate);

            object oMissing = System.Reflection.Missing.Value;
            object oEndOfDoc = "\\endofdoc";

            Word.Application wordApp = new Word.Application();
            base.InitWordApplication(wordApp, xmlDoc, Public.EMRType.出院记录);
