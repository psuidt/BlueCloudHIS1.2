...
namespace HIS_DJSFManager.窗口
{
    public partial class FrmInvoiceManager : GWI.HIS.Windows.Controls.BaseMainForm
    {
        ...
        public FrmInvoiceManager( string FormText , int CurrentEmployeeId )
        {
            InitializeComponent();
        ...
        private void FrmInvoiceManager_Load( object sender , EventArgs e )
        {
            ...
            cboAllotUser.SetSelectionCardDataSource( DataReader.Employeies );
        ...
        {
            dgvInvoiceList.DataSource = InvoiceManager.GetInvoiceRecord().DefaultView;
        ...
        {
            FrmAllotInvoice frm = new FrmAllotInvoice(  currentEmployeeId );
            frm.ShowDialog();
            ShowGridList( GetStatusFilterString() );
        }
        ...
        private void dgvInvoiceList_CurrentCellChanged( object sender , EventArgs e )
        {
            ...
            //try
            //{
            //    InvoiceManager.GetInvoiceListInfo( perfChar , startNo , endNo , out totalMoney , out totalCount , out refundMoney , out refundCount );
