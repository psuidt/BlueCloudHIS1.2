...
namespace HIS_DJSFManager.窗口
{
    public partial class FrmChargeInfo : GWI.HIS.Windows.Controls.BaseForm
    {
        ...
        private ChargeInfo returnChargeInfo;

        private bool cannotCancel;

        public ChargeInfo ReturnChargeInfo
        {
            get
            {
        ...
        public FrmChargeInfo(ChargeInfo chargeInfo)
        {
            InitializeComponent( );
        ...
        public FrmChargeInfo( ChargeInfo chargeInfo ,bool CannotCancel)
        {
            InitializeComponent( );
        ...
        private void btnOk_Click( object sender , EventArgs e )
        {
            ...
            ActPay = Convert.ToDecimal( txtActPay.Text );       //实收现金
            ReturnMoney = Convert.ToDecimal( txtReturn.Text );  //需找零
