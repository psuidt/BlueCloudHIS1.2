...
namespace HIS.DownUpLoadData
{
    ...
    public class DownloadController : BaseBLL
    {
        ...
        public DownloadController( int WorkId )
        {
            ConnectToAccessFile( );
            if ( WorkId != 0 )
                workid = WorkId;
        ...
        /// 下载所有用户
        /// </summary>
        public void DownLoadBaseUserData()
        {
            System.Data.OleDb.OleDbCommand cmd = accessConnection.CreateCommand( );
            string sql = "select a.employee_id,b.name ,a.code,a.password,a.workid from base_user a,base_employee_property b where a.employee_id=b.employee_id and a.workid=b.workid";
            ...
            for ( int i = 0 ; i < tbUser.Rows.Count ; i++ )
            {
                ...
                string _workid = getValue( tbUser.Rows[i]["workid"] , true );
                sql = "insert into base_user(employee_id,usercode,name,[password],workid) values (" + employee_id + ",'" + code + "','" + name + "','" + password + "'," + _workid + ")";
                cmd.CommandText = sql;
                cmd.ExecuteNonQuery( );
            }
        }
        ...
        private void DownLoad_Doctor( System.Data.OleDb.OleDbCommand cmd )
        {
            ...
            if ( AfterTableDownLoadOver != null )
                AfterTableDownLoadOver( "下载医生信息完成！(" + tbDoctor.Rows.Count.ToString( ) + ")条\r\n" );
        }
        ...
        private void DownLoad_MZFP_ITEM( System.Data.OleDb.OleDbCommand cmd )
        {
            ...
            if ( AfterTableDownLoadOver != null )
                AfterTableDownLoadOver( "下载发票项目完成！(" + tbMzfpItem.Rows.Count.ToString( ) + ")条\r\n" );
        }
        ...
        private void DownLoad_StatItem( System.Data.OleDb.OleDbCommand cmd )
        {
            ...
            if ( AfterTableDownLoadOver != null )
                AfterTableDownLoadOver( "下载统计大类完成！(" + tbStatItem.Rows.Count.ToString( ) + ")条\r\n" );
        }
        ...
        private void DownLoad_Base_PatientType( System.Data.OleDb.OleDbCommand cmd )
        {
            ...
            if ( AfterTableDownLoadOver != null )
                AfterTableDownLoadOver( "下载病人类型完成！(" + tbPatType.Rows.Count.ToString( ) + ")条\r\n" );
        }

        private void DownLoad_User( System.Data.OleDb.OleDbCommand cmd )
        {
            string sql = "select a.employee_id,b.name ,a.code,a.password,a.workid from base_user a,base_employee_property b where a.employee_id=b.employee_id and a.workid=" + workid + " and b.workid=" + workid;
            DataTable tbUser = oleDb.GetDataTable( sql );
            cmd.CommandText = "delete * from base_user";
            cmd.ExecuteNonQuery( );
            for ( int i = 0 ; i < tbUser.Rows.Count ; i++ )
            ...
            if ( AfterTableDownLoadOver != null )
                AfterTableDownLoadOver( "下载用户信息完成！(" + tbUser.Rows.Count.ToString( ) + ")条\r\n" );
        }
        ...
        private void DownLoad_Base_Dept_Property( System.Data.OleDb.OleDbCommand cmd )
        {
            ...
            if ( AfterTableDownLoadOver != null )
                AfterTableDownLoadOver( "下载科室信息完成！(" + tb.Rows.Count.ToString( ) + ")条\r\n" );
        }
        ...
        private void DownLoad_Base_Employee_Property( System.Data.OleDb.OleDbCommand cmd )
        {
            ...
            if ( AfterTableDownLoadOver != null )
                AfterTableDownLoadOver( "下载人员信息完成！(" + tb.Rows.Count.ToString( ) + ")条\r\n" );
        }
        ...
        private void DownLoad_ShowCard( System.Data.OleDb.OleDbCommand cmd )
        {
            ...
            if ( AfterTableDownLoadOver != null )
                AfterTableDownLoadOver( "下载服务项目、药品项目完成！(" + tbChargeItems.Rows.Count.ToString( ) + ")条\r\n" );
        }
        ...
        private void DownLoad_TemplateDetail( System.Data.OleDb.OleDbCommand cmd )
        {
            ...
            if ( AfterTableDownLoadOver != null )
                AfterTableDownLoadOver( "下载模板明细完成！(" + tbTempDetail.Rows.Count.ToString( ) + ")条\r\n" );
        }
        ...
        private void DownLoad_Base_Work_Unit( System.Data.OleDb.OleDbCommand cmd )
        {
            ...
            if ( AfterTableDownLoadOver != null )
                AfterTableDownLoadOver( "下载病人单位列表完成！(" + tb.Rows.Count.ToString( ) + ")条\r\n" );
        }
        ...
        private void DownLoad_MZ_Invoice( System.Data.OleDb.OleDbCommand cmd )
        {
            ...
            if ( AfterTableDownLoadOver != null )
                AfterTableDownLoadOver( "下载发票信息完成！(" + tb.Rows.Count.ToString( ) + ")条\r\n" );
        ...
        private void DownLoad_BASE_PATIENTTYPE_COST( System.Data.OleDb.OleDbCommand cmd )
        {
            ...
            if ( AfterTableDownLoadOver != null )
                AfterTableDownLoadOver( "下载类型打折设置完成！(" + tbPatType.Rows.Count.ToString( ) + ")条\r\n" );
        }
        ...
        private void DownLoad_BASE_ITEM_FAVORABLE( System.Data.OleDb.OleDbCommand cmd )
        {
            ...
            if ( AfterTableDownLoadOver != null )
                AfterTableDownLoadOver( "下载基本项目优惠设置完成！(" + tbPatType.Rows.Count.ToString( ) + ")条\r\n" );
        }
        ...
        private void DownLoad_BASE_ITEMMX_FAVORABLE( System.Data.OleDb.OleDbCommand cmd )
        {
            ...
            if ( AfterTableDownLoadOver != null )
                AfterTableDownLoadOver( "下载项目明细优惠设置完成！(" + tbPatType.Rows.Count.ToString( ) + ")条\r\n" );
        }
