    ...
    public class ReportController : BaseBLL
    {
        ...
        private static DataTable StatItemList
        {
            get
            {
                ...
                {
                    string sql = @"select a1.code,a1.item_name,a1.mzfp_code,a2.item_name as mzfp_name,a1.hs_code,a3.item_name as hs_name
        ...
        public static void FillReport( BaseReport Report  )
        {
            try
            {
                ...
                if (Report is PatientFeeReport)
                {
                    ...
                    drTotal[0] = "合  计";
                    for (int i = 3; i < Report.BaseReportData.Columns.Count; i++)
                    {
