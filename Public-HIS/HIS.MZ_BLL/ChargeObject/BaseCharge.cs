...
namespace HIS.MZ_BLL
{
    ...
    /// 基本结算对象
    /// </summary>
    public abstract class BaseCharge : HIS.SYSTEM.Core.BaseBLL
    {
        ...
        /// <returns></returns>
        public abstract bool Refundment( Invoice invoice, Prescription[] ReblancePrescriptions, List<int> ReturnedDocPresIdList );
