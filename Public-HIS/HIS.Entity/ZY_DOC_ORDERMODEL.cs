...
namespace HIS.Model
{
	public class ZY_DOC_ORDERMODEL
	{
		...
		private int _model_level;
		/// <summary>
		///
		/// </summary>
		public int MODEL_LEVEL
		{
			get{return _model_level;}
			set{_model_level = value ;}
		...
		private int _model_a1;
		/// <summary>
		///
		/// </summary>
		public int MODEL_A1
		{
			get{return _model_a1;}
			set{_model_a1 = value ;}

		}
		private int _model_a2;
		/// <summary>
		///
		/// </summary>
		public int MODEL_A2
		{
			get{return _model_a2;}
			set{_model_a2 = value ;}
